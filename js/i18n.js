...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'sb.pulse': 'Дашборд',
      'pulse.title': 'Пульс компании',
      'pulse.h1': 'Пульс компании — панель руководителя',
      'pulse.lead': 'ООО «Вектор» — вымышленная компания, где ИИ-сотрудники работают уже месяц. Все цифры — живые: фильтруйте, приближайте, кликайте по ролям.',
      'pulse.d.all': 'Все отделы', 'pulse.d.sales': 'Продажи', 'pulse.d.legal': 'Юротдел', 'pulse.d.sup': 'Поддержка',
      'pulse.r7': '7 дней', 'pulse.r30': '30 дней', 'pulse.r90': '90 дней',
      'pulse.k.rev': 'Выручка', 'pulse.k.leads': 'Заявки', 'pulse.k.ans': 'Ответов ИИ', 'pulse.k.hrs': 'Сэкономлено часов',
      'pulse.k.mo': 'за 30 дней · ▲▼ — к прошлому месяцу · клик по роли в графике покажет её вклад',
      'pulse.b2.t': 'Заявки и конверсия',
      'pulse.b3.t': 'Работа ИИ-сотрудников',
      'pulse.b4.t': 'Экономия за месяц',
      'pulse.b5.t': 'Нагрузка по часам · 24×7',
      'pulse.b6.t': 'ИИ-инсайты',
      'pulse.s.leads': 'Заявки', 'pulse.s.conv': 'Конверсия',
      'pulse.role.doc': 'Документовед', 'pulse.role.law': 'Юрист', 'pulse.role.op': 'Оператор', 'pulse.role.sec': 'Секретарь',
      'pulse.e.fot': 'ФОТ-эквивалент работы ИИ', 'pulse.e.sup': 'Поддержка ИИ',
      'pulse.e.pay': 'окупаемость', 'pulse.e.mo': 'мес',
      'pulse.h': 'ч',
      'pulse.heat.u': 'задач/час', 'pulse.heat.hi': 'пик', 'pulse.heat.lo': 'тихо',
      'pulse.i1': 'Пик заявок — {d}, {h}: Оператор закрывает {p}% обращений без людей',
      'pulse.i2': 'Юрист нашёл риски в {n} договорах за неделю — до подписания',
      'pulse.i3': '{p}% работы сделано ночью и в выходные — ИИ не спит и не болеет',
      'pulse.i4': 'Сэкономлено {h} часов за месяц — это {f} ставки специалиста',
      'pulse.i5': 'Конверсия выросла с {a}% до {b}% за 90 дней работы ИИ',
      'pulse.i6': 'Окупаемость внедрения при текущем темпе — {m} мес',
      ...
      'readme.pulse': 'Посмотреть дашборд «Пульс компании» →',
    ...
    en: {
      ...
      'sb.pulse': 'Dashboard',
      'pulse.title': 'Company Pulse',
      'pulse.h1': 'Company Pulse — the executive dashboard',
      'pulse.lead': 'Vektor LLC is a fictional company where AI employees have been working for a month. Every number is live: filter, zoom, click on roles.',
      'pulse.d.all': 'All teams', 'pulse.d.sales': 'Sales', 'pulse.d.legal': 'Legal', 'pulse.d.sup': 'Support',
      'pulse.r7': '7 days', 'pulse.r30': '30 days', 'pulse.r90': '90 days',
      'pulse.k.rev': 'Revenue', 'pulse.k.leads': 'Leads', 'pulse.k.ans': 'AI answers', 'pulse.k.hrs': 'Hours saved',
      'pulse.k.mo': 'last 30 days · ▲▼ — vs previous month · click a role in the chart to see its share',
      'pulse.b2.t': 'Leads & conversion',
      'pulse.b3.t': 'AI employees at work',
      'pulse.b4.t': 'Monthly savings',
      'pulse.b5.t': 'Load by hour · 24×7',
      'pulse.b6.t': 'AI insights',
      'pulse.s.leads': 'Leads', 'pulse.s.conv': 'Conversion',
      'pulse.role.doc': 'Docs Clerk', 'pulse.role.law': 'Lawyer', 'pulse.role.op': 'Support Op', 'pulse.role.sec': 'Secretary',
      'pulse.e.fot': 'Payroll equivalent of AI work', 'pulse.e.sup': 'AI support cost',
      'pulse.e.pay': 'payback', 'pulse.e.mo': 'mo',
      'pulse.h': 'h',
      'pulse.heat.u': 'tasks/hour', 'pulse.heat.hi': 'peak', 'pulse.heat.lo': 'quiet',
      'pulse.i1': 'Lead peak — {d}, {h}: the Support Op closes {p}% of requests with no humans',
      'pulse.i2': 'The Lawyer flagged risks in {n} contracts this week — before signing',
      'pulse.i3': '{p}% of the work happened at night and on weekends — AI never sleeps',
      'pulse.i4': '{h} hours saved this month — that is {f} full-time specialists',
      'pulse.i5': 'Conversion grew from {a}% to {b}% over 90 days of AI work',
      'pulse.i6': 'Payback of the rollout at the current pace — {m} months',
      ...
      'readme.pulse': 'See the Company Pulse dashboard →',
