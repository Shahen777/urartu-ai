...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'pulse.lead': 'Вымышленная компания, где месяц работают ИИ-сотрудники: штат и зарплаты, сделки и воронка, экономия. Переключайте вкладки, сортируйте таблицу, кликайте по ИИ-строкам.',
      ...
      'crm.t.hint': 'Сортировка — клик по заголовку столбца. Клик по строке с 🤖 — карточка ИИ-сотрудника.',
      ...
      'pulse.loading': 'Собираю графики… (~1,1 МБ, локально, без интернета)',
    ...
    en: {
      ...
      'pulse.lead': 'A fictional company where AI employees have been working for a month: staff and salaries, deals and funnel, savings. Switch tabs, sort the table, click the AI rows.',
      ...
      'crm.t.hint': 'Click a column header to sort. Click a 🤖 row for the AI employee card.',
      ...
      'pulse.loading': 'Building charts… (~1.1 MB, local, no internet)',
