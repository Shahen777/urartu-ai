...
(function () {
  ...
  /* t.title — сырой пользовательский ввод (форма «+ Новая задача»), идёт в
     innerHTML в нескольких местах рендера → обязательно эскейпить именно
     эту ветку (tr(t.k) — свой i18n-текст, экранировать не нужно). */
  function taskTitle(t) { return t.title ? esc(t.title) : tr(t.k); }
